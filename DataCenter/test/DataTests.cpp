...
TEST_F(DataTestFixture, sampleDataTest)
{
    EXPECT_EQ(0, 0);
}

TEST_F(DataTestFixture, setDataCollectionTests)
{
    EXPECT_EQ(true, true);
}

TEST_F(DataTestFixture, setDataPropertiesTests)
{
    EXPECT_EQ(true, true);
}

TEST_F(DataTestFixture, setDataFeatureTests)
{
    EXPECT_EQ(true, true);
}
